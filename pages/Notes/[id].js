    ...
    <motion.main initial="hidden" animate="enter" exit="exit" variants={variants} transition={{type: 'spring', stiffness: 80, duration: 0.2}}>
      <div className="relative bg-gradient-to-b min-h-screen w-screen flex flex-col justify-start from-[#001327] via-[#002335] to-[#030310] text-white">
        ...
        <div className="container w-screen justify-center align-middle flex-wrap mx-auto flex md:px-10 md:py-14 md:flex-row flex-col items-start">
            ...
            <svg className="h-40 md:block hidden w-60 md:h-80 md:w-96" width="362.52377" height="438.18799" viewBox="0 0 362.52377 438.18799">
              ...
              <g>
                ...
                <path
                  ...
                  fill="#ccc"
                />
                <path d="M268.54319,142.42286l-.125-1.99609c1.94336-.12158,3.9751-.20166,6.03906-.23877l.03613,2c-2.03467,.03613-4.03662,.11523-5.9502,.23486Z" fill="#ccc" />
              </g>
              <g>
                <path
              ...
              <polygon
                ...
                fill="#2f2e41"
              />
              <path d="M175.47532,157.18799l-33-2-11,14-24,9,11,107-5,64s70,56,100-6l-8-75,2-87-23-10-9-14Z" fill="#6c63ff" />
              <g>
                <path
              ...
              <g>
                <ellipse cx="12.46328" cy="12.52176" rx="12.46328" ry="12.20069" fill="#6c63ff" />
                <path
          ...
          <div className="lg:flex-grow justify-center align-middle w-full md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <form onSubmit={handleSubmit} className="m-2">
              <div className="shadow-2xl m-2 bg-[#ffffff36] md:w-96 w-80  rounded-3xl p-3">
                <div className="p-3">
                  <textarea
                    id="title"
                    required
              ...
              <div className="flex justify-center w-full flex-row">
                <div className="m-1">
                  <Link href={'/Notes'}>
                    <div className="inline-flex m-1 items-center justify-center p-3 text-3xl font-bold text-center text-gray-100 bg-gray-900 rounded-full hover:bg-gray-700 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900">
                      <svg className="w-8 h-8 text-gray-100 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                          fillRule="evenodd"
                ...
                <div className="m-1">
                  ...
                  {Loader === true ? (
                    <button
                      disabled
                      type="button"
                      className="inline-flex m-1 items-center justify-center p-3 text-3xl font-bold text-center text-gray-100 bg-gray-900 rounded-full hover:bg-gray-700 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900">
                    ...
                    <button
                      type="submit"
                      className="inline-flex m-1 items-center justify-center p-3 text-3xl font-bold text-center text-gray-100 bg-gray-900 rounded-full hover:bg-gray-600 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900">
                ...
                <div className="m-1">
                  {isDelete === true ? (
                    ...
                    <button
                      ...
                      className="inline-flex m-1 items-center justify-center p-3 text-3xl font-bold text-center text-gray-100 bg-gray-900 rounded-full hover:bg-gray-700 focus:ring-4 focus:ring-gray-900 dark:focus:ring-gray-900">
                      <svg className="w-8 h-8 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                          fillRule="evenodd"
